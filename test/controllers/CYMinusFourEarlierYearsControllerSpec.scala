...
class CYMinusFourEarlierYearsControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  "CYMinusFourEarlierYearsController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, cyMinusFourEarlierYearsRoute)
      ...
      verify(mockTaxYearRange).yearAtStart(CYMinus4TaxYears)
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, cyMinusFourEarlierYearsRoute)
