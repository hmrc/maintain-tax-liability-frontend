...
class CYMinusOneYesNoControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  lazy val cyMinusOneYesNoRoute: String = routes.CYMinusOneYesNoController.onPageLoad().url
  ...
  "CYMinusOneLiabilityController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, cyMinusOneYesNoRoute)
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(CYMinusOneYesNoPage, validAnswer).success.value
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, cyMinusOneYesNoRoute)
