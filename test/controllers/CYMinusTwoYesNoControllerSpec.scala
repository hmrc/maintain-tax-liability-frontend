...
class CYMinusTwoYesNoControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  lazy val cyMinusTwoYesNoRoute: String = routes.CYMinusTwoYesNoController.onPageLoad().url
  ...
  "CYMinusTwoLiabilityController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, cyMinusTwoYesNoRoute)
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(CYMinusTwoYesNoPage, validAnswer).success.value
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, cyMinusTwoYesNoRoute)
