...
object TaskStatus extends Enumeration {
  ...
  implicit val reads: Reads[models.TaskStatus.Value] = Reads.enumNameReads(TaskStatus)
  implicit val writes: Writes[Value] = Writes.enumNameWrites
  implicit val format: Format[models.TaskStatus.Value] = Format.apply(reads, writes)
